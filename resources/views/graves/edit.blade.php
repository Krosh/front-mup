        ...
        <div>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="main">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Редактироване объекта grave {{ $grave->id }}</div>
                ...
                <div role="tabpanel" class="tab-pane" id="dead">
                    <a href="{{ url('/deads/create',["idGrave" => $grave->id]) }}" class="btn btn-primary" title="Добавить новый элемент grave">Добавить новый элемент grave</a>
                    <br/>
                    <br/>
