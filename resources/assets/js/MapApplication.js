...
var MapApplication = function(baseUrl) {
    ...
    this.search = function() {
        aja()
            ...
            .data({
                ...
                deathYear: $(".js-search-death-year").val(),
                deathMonth: $(".js-search-death-month").val(),
                deathDay: $(".js-search-death-day").val(),
            })
    ...
    this.showPanel = function(params) {
        ...
        if (params.status)
            $(".card .js-status-icon").removeClass("fa-unlock-alt").addClass("fa-lock");
        else
            $(".card .js-status-icon").addClass("fa-unlock-alt").removeClass("fa-lock");
